...
//			System.out.println(stack.getTop().getNext().getElement());
//			System.out.println(stack.getTop().getPrevious().getElement());
...
//			System.out.println("last" + node.getElement());
			if (!node.getElement().equals("7")) testPassed = false;
		}  catch (Exception e) {
//			System.out.println(e);
			testPassed = false;
